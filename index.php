...
} elseif(preg_match("/app\/auto\/rugs\d{1,2}\/m\d{1,3}/", $_GET['route'])) {
...
} elseif(preg_match("/app\/auto\/capes\d{1,2}\/m\d{1,3}/", $_GET['route'])) {
    require_once "./app/content/capes/item.php";

<div class="labels">
    <div class="container">
        <div class="labels__wrap">
            <div class="labels__arrow__left">
                <button>&lt;</button>
            </div>
            <div class="labels__inner">
                <div class="label__item">
                    <a href="/app/auto/a2" class="labels__item__link">
                        <img src="/app/img/dest/labels/audi.png" alt="">
                    </a>
                </div>
                <div class="label__item">
                    <a href="/app/auto/a3" class="labels__item__link">
                        <img src="/app/img/dest/labels/bmw.jpg" alt="">
                    </a>
                </div>
                <div class="label__item">
                    <a href="/app/auto/a4" class="labels__item__link">
                        <img src="/app/img/dest/labels/byd.png" alt="">
                    </a>
                </div>
                <div class="label__item">
                    <a href="/app/auto/a5" class="labels__item__link">
                        <img src="/app/img/dest/labels/brilliance.png" alt="">
                    </a>
                </div>
                <div class="label__item">
                    <a href="/app/auto/a6" class="labels__item__link">
                        <img src="/app/img/dest/labels/changan.png" alt="">
                    </a>
                </div>
                <div class="label__item">
                    <a href="/app/auto/a7" class="labels__item__link">
                        <img src="/app/img/dest/labels/chery.png" alt="">
                    </a>
                </div>
                <div class="label__item">
                    <a href="/app/auto/a8" class="labels__item__link">
                        <img src="/app/img/dest/labels/chevrolet.jpg" alt="">
                    </a>
                </div>
                <div class="label__item">
                    <a href="/app/auto/a9" class="labels__item__link">
                        <img src="/app/img/dest/labels/chrysler.jpg" alt="">
                    </a>
                </div>
                <div class="label__item">
